...
public class ProxyUserMiddlewareImpl implements ProxyUserMiddleware {
    ...
    @Override
    public User findByExtLogins(DataAdapter preferredAdapter, String idpEntityId, List<String> userIdentifiers) throws PerunUnknownException, RpcConnectionException {
        return preferredAdapter.getPerunUser(idpEntityId, userIdentifiers);
    }

    @Override
    public User findByExtLogin(DataAdapter preferredAdapter, String idpIdentifier, String login) throws PerunUnknownException, RpcConnectionException {
        return findByExtLogins(preferredAdapter, idpIdentifier, Collections.singletonList(login));
    }

    @Override
    public Map<String, PerunAttributeValue> getAttributesValues(DataAdapter preferredAdapter, Entity entity, long id, List<String> attributes) throws PerunUnknownException, RpcConnectionException {
